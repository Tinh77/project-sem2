...
return [
    ...
    */
    ...
    'laravelUsersBladeExtended'     => 'vendor.laravelusers.layouts.app', // 'layouts.app'
    ...
    'subUserModel'                  => 'App\Account',

    // Use the provided blade templates or extend to your own templates.
    'showUsersBlade'                => 'vendor.laravelusers.users.list',
    'createUserBlade'               => 'vendor.laravelusers.users.create',
    'showIndividualUserBlade'       => 'vendor.laravelusers.users.show',
    'editIndividualUserBlade'       => 'vendor.laravelusers.users.edit',
    // categories
    'showCategoriesBlade'                => 'vendor.laravelusers.categories.list',
    'createCategoryBlade'               => 'vendor.laravelusers.categories.create',
    'showIndividualCategoryBlade'       => 'vendor.laravelusers.categories.show',
    'editIndividualCategoryBlade'       => 'vendor.laravelusers.categories.edit',
    // gifts
    'showGiftsBlade'                => 'vendor.laravelusers.gifts.list',
    'createGiftBlade'               => 'vendor.laravelusers.gifts.create',
    'showIndividualGiftBlade'       => 'vendor.laravelusers.gifts.show',
    'editIndividualGiftBlade'       => 'vendor.laravelusers.gifts.edit',
    // transactions
    'showTransactionsBlade'         => 'vendor.laravelusers.transactions.list',
    'createTransactionBlade'               => 'vendor.laravelusers.transactions.create',
    'showIndividualTransactionBlade'       => 'vendor.laravelusers.transactions.show',
    'editIndividualTransactionBlade'       => 'vendor.laravelusers.transactions.edit',
