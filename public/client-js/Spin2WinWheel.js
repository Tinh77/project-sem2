function Spin2WinWheel() {
  ...
  var xmlns = "http://www.w3.org/2000/svg",
    ...
    spinVelocityTracker,
    gameResultsArray = [],
    pegSnd = new Audio('https://s3-us-west-2.amazonaws.com/s.cdpn.io/35984/wheel_tick.mp3'),
    ...
    spinComplete = function(next) {
      ...
      normalizedRotation = (normalizedRotation < 0) ? normalizedRotation *= -1 : normalizedRotation;
        console.log("curr wheel pos: " + currentWheelPos);
        console.log("gstrans: "+ wheel._gsTransform.rotation);
      var segId = Math.round(normalizedRotation / rotationStep);
      var winningSegment = segmentArray[segId].path;
      console.log(segId);
